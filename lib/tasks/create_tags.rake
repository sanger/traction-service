  ...
  namespace :create do
    ...
    task nextera_ud: :environment do
      ...
      [
        ...
        {group_id: 'UDP0001_i5', oligo: 'TCGTGGAGCG'},
        {group_id: 'UDP0002_i5', oligo: 'CTACAAGATA'},
        {group_id: 'UDP0003_i5', oligo: 'TATAGTAGCT'},
        {group_id: 'UDP0004_i5', oligo: 'TGCCTGGTGG'},
        {group_id: 'UDP0005_i5', oligo: 'ACATTATCCT'},
        {group_id: 'UDP0006_i5', oligo: 'GTCCACTTGT'},
        {group_id: 'UDP0007_i5', oligo: 'TGGAACAGTA'},
        {group_id: 'UDP0008_i5', oligo: 'CCTTGTTAAT'},
        {group_id: 'UDP0009_i5', oligo: 'GTTGATAGTG'},
        {group_id: 'UDP0010_i5', oligo: 'ACCAGCGACA'},
        {group_id: 'UDP0011_i5', oligo: 'CATACACTGT'},
        {group_id: 'UDP0012_i5', oligo: 'GTGTGGCGCT'},
        {group_id: 'UDP0013_i5', oligo: 'ATCACGAAGG'},
        {group_id: 'UDP0014_i5', oligo: 'CGGCTCTACT'},
        {group_id: 'UDP0015_i5', oligo: 'GAATGCACGA'},
        {group_id: 'UDP0016_i5', oligo: 'AAGACTATAG'},
        {group_id: 'UDP0017_i5', oligo: 'TCGGCAGCAA'},
        {group_id: 'UDP0018_i5', oligo: 'CTAATGATGG'},
        {group_id: 'UDP0019_i5', oligo: 'GGTTGCCTCT'},
        {group_id: 'UDP0020_i5', oligo: 'CGCACATGGC'},
        {group_id: 'UDP0021_i5', oligo: 'GGCCTGTCCT'},
        {group_id: 'UDP0022_i5', oligo: 'CTGTGTTAGG'},
        {group_id: 'UDP0023_i5', oligo: 'TAAGGAACGT'},
        {group_id: 'UDP0024_i5', oligo: 'CTAACTGTAA'},
        {group_id: 'UDP0025_i5', oligo: 'GGCGAGATGG'},
        {group_id: 'UDP0026_i5', oligo: 'AATAGAGCAA'},
        {group_id: 'UDP0027_i5', oligo: 'TCAATCCATT'},
        {group_id: 'UDP0028_i5', oligo: 'TCGTATGCGG'},
        {group_id: 'UDP0029_i5', oligo: 'TCCGACCTCG'},
        {group_id: 'UDP0030_i5', oligo: 'CTTATGGAAT'},
        {group_id: 'UDP0031_i5', oligo: 'GCTTACGGAC'},
        {group_id: 'UDP0032_i5', oligo: 'GAACATACGG'},
        {group_id: 'UDP0033_i5', oligo: 'GTCGATTACA'},
        {group_id: 'UDP0034_i5', oligo: 'ACTAGCCGTG'},
        {group_id: 'UDP0035_i5', oligo: 'AAGTTGGTGA'},
        {group_id: 'UDP0036_i5', oligo: 'TGGCAATATT'},
        {group_id: 'UDP0037_i5', oligo: 'GATCACCGCG'},
        {group_id: 'UDP0038_i5', oligo: 'TACCATCCGT'},
        {group_id: 'UDP0039_i5', oligo: 'GCTGTAGGAA'},
        {group_id: 'UDP0040_i5', oligo: 'CGCACTAATG'},
        {group_id: 'UDP0041_i5', oligo: 'GACAACTGAA'},
        {group_id: 'UDP0042_i5', oligo: 'AGTGGTCAGG'},
        {group_id: 'UDP0043_i5', oligo: 'TTCTATGGTT'},
        {group_id: 'UDP0044_i5', oligo: 'AATCCGGCCA'},
        {group_id: 'UDP0045_i5', oligo: 'CCATAAGGTT'},
        {group_id: 'UDP0046_i5', oligo: 'ATCTCTACCA'},
        {group_id: 'UDP0047_i5', oligo: 'CGGTGGCGAA'},
        {group_id: 'UDP0048_i5', oligo: 'TAACAATAGG'},
        {group_id: 'UDP0049_i5', oligo: 'CTGGTACACG'},
        {group_id: 'UDP0050_i5', oligo: 'TCAACGTGTA'},
        {group_id: 'UDP0051_i5', oligo: 'ACTGTTGTGA'},
        {group_id: 'UDP0052_i5', oligo: 'GTGCGTCCTT'},
        {group_id: 'UDP0053_i5', oligo: 'AGCACATCCT'},
        {group_id: 'UDP0054_i5', oligo: 'TTCCGTCGCA'},
        {group_id: 'UDP0055_i5', oligo: 'CTTAACCACT'},
        {group_id: 'UDP0056_i5', oligo: 'GCCTCGGATA'},
        {group_id: 'UDP0057_i5', oligo: 'CGTCGACTGG'},
        {group_id: 'UDP0058_i5', oligo: 'TACTAGTCAA'},
        {group_id: 'UDP0059_i5', oligo: 'ATAGACCGTT'},
        {group_id: 'UDP0060_i5', oligo: 'ACAGTTCCAG'},
        {group_id: 'UDP0061_i5', oligo: 'AGGCATGTAG'},
        {group_id: 'UDP0062_i5', oligo: 'GCAAGTCTCA'},
        {group_id: 'UDP0063_i5', oligo: 'TTGGCTCCGC'},
        {group_id: 'UDP0064_i5', oligo: 'AACTGATACT'},
        {group_id: 'UDP0065_i5', oligo: 'GTAAGGCATA'},
        {group_id: 'UDP0066_i5', oligo: 'AATTGCTGCG'},
        {group_id: 'UDP0067_i5', oligo: 'TTACAATTCC'},
        {group_id: 'UDP0068_i5', oligo: 'AACCTAGCAC'},
        {group_id: 'UDP0069_i5', oligo: 'TCTGTGTGGA'},
        {group_id: 'UDP0070_i5', oligo: 'GGAATTCCAA'},
        {group_id: 'UDP0071_i5', oligo: 'AAGCGCGCTT'},
        {group_id: 'UDP0072_i5', oligo: 'TGAGCGTTGT'},
        {group_id: 'UDP0073_i5', oligo: 'ATCATAGGCT'},
        {group_id: 'UDP0074_i5', oligo: 'TGTTAGAAGG'},
        {group_id: 'UDP0075_i5', oligo: 'GATGGATGTA'},
        {group_id: 'UDP0076_i5', oligo: 'ACGGCCGTCA'},
        {group_id: 'UDP0077_i5', oligo: 'CGTTGCTTAC'},
        {group_id: 'UDP0078_i5', oligo: 'TGACTACATA'},
        {group_id: 'UDP0079_i5', oligo: 'CGGCCTCGTT'},
        {group_id: 'UDP0080_i5', oligo: 'CAAGCATCCG'},
        {group_id: 'UDP0081_i5', oligo: 'TCGTCTGACT'},
        {group_id: 'UDP0082_i5', oligo: 'CTCATAGCGA'},
        {group_id: 'UDP0083_i5', oligo: 'AGACACATTA'},
        {group_id: 'UDP0084_i5', oligo: 'GCGCGATGTT'},
        {group_id: 'UDP0085_i5', oligo: 'CATGAGTACT'},
        {group_id: 'UDP0086_i5', oligo: 'ACGTCAATAC'},
        {group_id: 'UDP0087_i5', oligo: 'GATACCTCCT'},
        {group_id: 'UDP0088_i5', oligo: 'ATCCGTAAGT'},
        {group_id: 'UDP0089_i5', oligo: 'CGTGTATCTT'},
        {group_id: 'UDP0090_i5', oligo: 'GAACCATGAA'},
        {group_id: 'UDP0091_i5', oligo: 'GGCCATCATA'},
        {group_id: 'UDP0092_i5', oligo: 'ACATACTTCC'},
        {group_id: 'UDP0093_i5', oligo: 'TATGTGCAAT'},
        {group_id: 'UDP0094_i5', oligo: 'GATTAAGGTG'},
        {group_id: 'UDP0095_i5', oligo: 'ATGTAGACAA'},
        {group_id: 'UDP0096_i5', oligo: 'CACATCGGTG'}        
      ].each do |tag_attributes|
        set.tags.find_or_create_by!(tag_attributes)
      end
