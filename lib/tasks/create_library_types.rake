...
namespace :library_types do
  ...
  task create: :environment do
    [
      ...
      { pipeline: 'pacbio', name: 'Pacbio_AmpliFi', external_identifier: '>=3kb amplicons' },
      { pipeline: 'pacbio', name: 'Pacbio_Kinnex_Single_Cell_3', external_identifier: 'Kinnex single-cell RNA' },
      { pipeline: 'pacbio', name: 'Pacbio_Kinnex_Single_Cell_5', external_identifier: 'Kinnex single-cell RNA' },
      { pipeline: 'pacbio', name: 'Pacbio_Kinnex_Full_Length', external_identifier: 'Kinnex full-length RNA' },
