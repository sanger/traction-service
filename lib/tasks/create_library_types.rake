...
namespace :library_types do
  ...
  task create: :environment do
    [
      ...
      { pipeline: 'pacbio', name: 'Pacbio_Ampli_Fi', external_identifier: '>=3kb amplicons' },
      { pipeline: 'pacbio', name: 'Pacbio_Kinnex_Single_Cell', external_identifier: 'Kinnex single-cell RNA' },
