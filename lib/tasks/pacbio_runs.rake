...
namespace :pacbio_runs do
  task create: :environment do
    ...
    Pacbio::Request.all.each_with_index do |request, i|
      ...
      Pacbio::RequestLibrary.create!(library: library, request: request, tag: Tag.find(1+rand(16))) 
  ...
  task destroy: :environment do
    Sample.all.each{|sample| sample.destroy if sample.requests[0].requestable_type == "Pacbio::Request"}
