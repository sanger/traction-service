...
module Emq
  # This class should be responsible for validating messages against an Avro schema
  ...
  class Validator
    ...
    # @param [Hash] message the message to validate
    def validate_message(message)
      encode_message(message, create_message_schema)
    ...
    # @param [String] schema the schema to use for encoding
    # @return [String] the encoded message
    def encode_message(message, schema) # rubocop:disable Metrics/MethodLength
      begin
