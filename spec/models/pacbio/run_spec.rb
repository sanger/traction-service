...
RSpec.describe Pacbio::Run, pacbio: true do
  ...
  let!(:version12) { create(:pacbio_smrt_link_version, name: 'v12_sequel', default: true) }
  ...
  context 'validation' do
    ...
    context 'v10 and v11' do
      it 'must have a DNA control complex kit box barcode' do
        expect(build(:pacbio_sequel_run, smrt_link_version: version10, dna_control_complex_box_barcode: nil)).not_to be_valid
      end
    end
