...
RSpec.describe QcResultsUploadValidator do
  describe '#validate' do
    ...
    describe '#validate_used_by' do
      it 'when used by is nil' do
        qc_results_upload = build(:qc_results_upload, used_by: nil)
        record = build(:qc_results_upload_factory, qc_results_upload:)
        described_class.new({ required_headers: }).validate(record)
        expect(record).not_to be_valid
        expect(record.errors.messages[:used_by]).to eq ["can't be blank"]
      end

      it 'when used_by does not match QcAssayTypes' do
        qc_results_upload = build(:qc_results_upload, used_by: 'unknown')
        record = build(:qc_results_upload_factory, qc_results_upload:)
        described_class.new({ required_headers: }).validate(record)
        expect(record).not_to be_valid
    ...
    describe '#validate_csv_data' do
      it 'when csv_data is nil' do
        qc_results_upload = build(:qc_results_upload, csv_data: nil)
        record = build(:qc_results_upload_factory, qc_results_upload:)
        described_class.new({ required_headers: }).validate(record)
        expect(record).not_to be_valid
    ...
    describe '#validate_rows' do
      it 'when csv_data is empty' do
        qc_results_upload = build(:qc_results_upload, csv_data: 'line one \n')
        record = build(:qc_results_upload_factory, qc_results_upload:)
        described_class.new({ required_headers: }).validate(record)
        expect(record).not_to be_valid
      ...
      it 'when data is missing' do
        csv_dupl_headers = ",,SAMPLE INFORMATION,,,,,,,,,,,,,VOUCHERING,,,,EXTRACTION/QC,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,COLUMN JUST FOR TOL,COLUMN JUST FOR TOL,SE LIMS,
        ...
        qc_results_upload = build(:qc_results_upload, csv_data: csv_dupl_headers)
        record = build(:qc_results_upload_factory, qc_results_upload:)
        described_class.new({ required_headers: }).validate(record)
        expect(record).not_to be_valid
    ...
    describe '#validate_headers' do
      it 'when csv_data contains duplicate headers' do
        csv_dupl_headers = ",,SAMPLE INFORMATION,,,,,,,,,,,,,VOUCHERING,,,,EXTRACTION/QC,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,COLUMN JUST FOR TOL,COLUMN JUST FOR TOL,SE LIMS,
